                ...
                <div class="panel-body">
                    <form>
                        <?php if ($value['type'] == 'choose'): ?>
                            ...
                            <?php $choose_option = 'A'?>
                            <?php foreach ($value['question_choose'] as $key => $question_choose): ?>
                                <input type="radio"  name="<?= $value['question_id'] ?>" value="<?= $choose_option?>"><?= $choose_option++ . '. ' . $question_choose?><br/>
                            <?php endforeach;?>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if ($value['type'] == 'multi_choose'): ?>
                            ...
                            <?php foreach ($value['question_choose'] as $question_choose): ?>
                                <input type="checkbox" value="<?= $choose_option ?>"><?= $choose_option++ . '. ' . $question_choose ?><br/>
                            <?php endforeach;?>
                            </div>
                        <?php endif; ?>
