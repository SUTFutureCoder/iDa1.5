...
<body>
    <br/>
    <button class="btn btn-lg btn-success col-sm-10 col-sm-offset-1" onclick="window.open('admin_add_user/getexceltemplate')">模板下载</button>
    <br/>
    <br/>
    <br/>
    <form action="admin_add_user/addUserBatch" enctype="multipart/form-data" class="form-horizontal" role="form" id="form_add_user_batch" role="form" method="post">
        <div class="form-group">
            <label for="upload_user_file" class="col-sm-2 control-label">模板上传</label>
            <div class="col-sm-9">
                <input class="form-control"  type="file" name="upload_user_file" id="upload_user_file">
            </div>
            <br/>
            <br/>
    ...
    <script>
        $(function(){
            ...
            $("#form_add_user_batch").ajaxForm(options);
        })
    </script>
</html>